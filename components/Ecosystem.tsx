...
import { Database, Fingerprint, History, LockKeyhole, Smartphone, Network, Building2, LeafyGreen, ShieldCheck, ShoppingCart, Truck, CheckCircle, Activity, Box } from "lucide-react";
