...
export default function ProductSection() {
    ...
    const openModal = (product: typeof products[0]) => {
        setModalProduct({ id: product.id, title: product.title, image: product.image });
        setIsModalOpen(true);
    };
                                    ...
                                    <div className="flex flex-wrap gap-4">
                                        ...
                                        >
                                            <button
                                                ...
                                                className="group inline-flex items-center gap-2 px-6 py-3 rounded-full text-base font-semibold text-green-700 dark:text-green-400 border-2 border-green-200 dark:border-green-800 hover:bg-green-50 dark:hover:bg-green-900/20 hover:border-green-400 dark:hover:border-green-600 transition-all duration-300"
                                            >
                                                Read More
